...
\begin{figure}[H]
    \centering
    \input{figures/weight_distribution.tex}
...
\begin{figure}[H]
    \centering
    \input{figures/frame_dimensions.tex}
...
\begin{figure}[H]
    \centering
    \input{figures/diff_drive_kinematics.tex}
    \caption{Three differential-drive operating modes. Arrows indicate track linear
    velocity; the red dot marks the instantaneous center of rotation. The planner
    commands all three modes through a single $(v, \omega)$ target.}
...
\begin{figure}[H]
    \centering
    \input{figures/drivetrain_block.tex}
...
\begin{figure}[H]
    \centering
    \input{figures/safety_block.tex}
